...
private let samples: [Sample] = [
    ...
    Sample(token: "language", expected: .english),
    Sample(token: "database", expected: .english),
    Sample(token: "delete", expected: .english),
    Sample(token: "feature", expected: .english),
    Sample(token: "system", expected: .english),
    Sample(token: "software", expected: .english),
    Sample(token: "because", expected: .english),
    Sample(token: "normal", expected: .english),
    Sample(token: "casual", expected: .english),
    Sample(token: "office", expected: .english),
    Sample(token: "cursor", expected: .english),
    Sample(token: "plugin", expected: .english),
    Sample(token: "words", expected: .english),
    Sample(token: "final", expected: .english),
    Sample(token: "women", expected: .pinyin),
    Sample(token: "nimen", expected: .pinyin),
    Sample(token: "tamen", expected: .pinyin),
    Sample(token: "mama", expected: .pinyin),
    Sample(token: "baba", expected: .pinyin),
    Sample(token: "laoshi", expected: .pinyin),
    Sample(token: "qingchu", expected: .pinyin),
    ...
    Sample(token: "lang", expected: .unknown),
    Sample(token: "long", expected: .unknown),
    Sample(token: "can", expected: .unknown),
